...
urlpatterns = [
    ...
    url(r'^api/attendees/(?P<attendee>\d+)/songqueues/$', views.SongQueueListCreateAPIView.as_view(), name='song_queue_list_create'),
    ...
    url(r'^api/attendees/(?P<attendee>\d+)/songqueues/(?P<pk>\d+)/$', views.SongQueueRetrieveUpdateDestroyAPIView.as_view(), name='song_queue_retrieve_update_destroy'),
